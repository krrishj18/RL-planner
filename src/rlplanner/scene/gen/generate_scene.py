...
# Not vendored: both only decorate a USD stage (street furniture, road paint) and
# neither feeds the 2.5D export. Kept as module attributes so the pipeline below
# reads like upstream and tests can monkeypatch them.
city_detail = None
road_markings = None
...
def generate_scene_on_stage(stage,
    ...
    if road_markings is not None:
        ...
        road_markings.apply(stage, config, layout, parent_path,
                            scene_scale_factor, hydrants=_at("fire_hydrant"),
